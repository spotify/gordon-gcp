...
def pubsub_msg(mocker, raw_msg_data):
    ...
    pubsub_msg._ack_id = 'projects/a-project/subscriptions/test-sub:1413'
    pubsub_msg.message_id = '5678'
...
def test_thread_pubsub_msg(consumer, event, pubsub_msg, mocker, monkeypatch):
    ...
    thread.assert_called_once_with(
        event.return_value, 'GPSThread_msg-id_5678', daemon=True)
    ...
    assert ret_event, ret_thread == consumer._threads[pubsub_msg._ack_id]
